...
/// </summary>
public class MapOperation : ValueTransformationBase
{
    /// <inheritdoc />
    public override string EnumMemberName { get; } = nameof(MapOperation);
    ...
    {
        var clone = (MapOperation)MemberwiseClone();
...
/// <summary>
/// The extension methods for the <see cref="MapOperation" /> to be used with the scripting engine.
/// </summary>
public static class MapOperationExtensions
{
    /// <summary>
    ...
    public static TransformationResult Map(this TransformationResult result, List<ValueMap> valueMappings, string? fieldName)
    {
        ...
        var mappedValue = lookups.FirstOrDefault(x => x.FromValue == value);
