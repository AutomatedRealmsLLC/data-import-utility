...
public class GreaterThanOperation : ComparisonOperationBase
{
    ...
    public override async Task<TransformationResult<bool>> Evaluate(ITransformationContext context)
    {
        ...
        return TransformationResult<bool>.CreateSuccess(leftResult.GreaterThan(rightResult), context);
    }
...
public static class GreaterThanOperationExtensions
{
    ...
    public static bool GreaterThan(this TransformationResult<string?> leftResult, TransformationResult<string?> rightResult)
    {
        // Handle null cases
