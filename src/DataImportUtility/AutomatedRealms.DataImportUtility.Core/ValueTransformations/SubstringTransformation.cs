...
public class SubstringTransformation : ValueTransformationBase
{
    ...
    /// </summary>
    public static readonly string TypeIdString = "Core.SubstringTransformation";
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SubstringTransformation"/> class.
    /// </summary>
    public SubstringTransformation() : base(TypeIdString) { }
    ...
    /// <summary>
    /// Generates the syntax for the transformation detail based on StartIndex and MaxLength.
    /// </summary>
    private void GenerateSyntax() // Removed protected override
    {
        // Create a simple JSON-like or delimited string for TransformationDetail
        // Example: "start:0,length:10"
