...
{    /// <summary>
    /// The data for tests for the <see cref="AutomatedRealms.DataImportUtility.Abstractions.MappingRuleBase.Apply(AutomatedRealms.DataImportUtility.Abstractions.ITransformationContext)" /> method.
    /// </summary>
